  ...
  return (
    <div className="flex min-h-dvh flex-col items-center justify-center px-8">
      <div className="mb-8 flex flex-col items-center">
        <div className="mb-4 flex size-20 items-center justify-center rounded-3xl bg-gradient-to-br from-hero-from to-hero-to text-white shadow-lg shadow-black/10">
          <Citrus size={40} />
        </div>
      ...
      <div className="w-full max-w-xs space-y-4">
        <button
          onClick={githubLogin}
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-ink py-3 text-sm font-medium text-white active:scale-[0.98]"
        >
        ...
        <div className="space-y-2.5">
          ...
          <button
            ...
            disabled={busy}
            className="w-full rounded-xl bg-accent py-3 text-sm font-medium text-white active:scale-[0.98] disabled:opacity-50"
          >
            访客登录
          </button>
        </div>
